...
public class Tapahtumankuuntelija implements EventHandler {
  ...
  public Tapahtumankuuntelija(
    ...
    this.komennot.put(
        plus,
        new Summa(tuloskentta, syotekentta, nollaa, undo, sovellus)
      );
    this.komennot.put(
        miinus,
        new Erotus(tuloskentta, syotekentta, nollaa, undo, sovellus)
      );
    this.komennot.put(
        nollaa,
        new Nollaa(tuloskentta, syotekentta, nollaa, undo, sovellus)
      );
  }
